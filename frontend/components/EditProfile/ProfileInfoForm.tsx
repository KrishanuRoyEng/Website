...
import { User, Briefcase, Code, Link as LinkIcon, Award, Save, X, ExternalLink } from 'lucide-react';
        ...
        <form onSubmit={handleSaveProfile} className="space-y-4 md:space-y-6">
            ...
            <div className={CARD_CLASS}>
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-white">Basic Information</h2>
                </div>
            ...
            <div className={CARD_CLASS}>
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-white">Social Links</h2>
                </div>
            ...
            <div className={CARD_CLASS}>
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-white">Skills & Expertise</h2>
                </div>

                {selectedSkillsData.length > 0 && (
                    <div className="mb-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                        <p className="text-sm font-medium text-slate-400 mb-3">Selected Skills ({selectedSkillsData.length})</p>
